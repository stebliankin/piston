...
config['dirs']['data_prepare'] = os.getcwd()+'/../masif_test/'
config['dirs']['raw_pdb'] = config['dirs']['data_prepare'] + 'PDB/'
config['dirs']['basename'] = config['dirs']['data_prepare'] + 'prepare_energies_20R/'
...
config['ppi_const']['patch_r'] = 20 # 16
config['ppi_const']['crop_r'] = config['ppi_const']['patch_r'] + 1 # radius to crop (in Angstroms)

config['ppi_const']['points_in_patch'] = 800 # 400 for 16 radius
